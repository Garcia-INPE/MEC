...
#  'CUSTOM'=  paste0(format(CFG$dt, format='%Y-%m-%d '), hh.targ,'h'),
  'CUSTOM'=  paste0(season, " ", hh.targ,'h'),
...
#      'CUSTOM'=  paste0(CFG$var, '_', CFG$obs),
      'CUSTOM'=  paste0(CFG$var, '_', CFG$obs, '_', season),
    ...
    fname.img <- switch(fig.type,
#      'CUSTOM'=  paste0(CFG$var, '_', CFG$model, '_', CFG$ltime),
      'CUSTOM'= paste0(CFG$var, '_', CFG$model, '_', CFG$ltime, '_', season),
...
# ==============================================================================
  ...
  my.direction <- "UpDown"
  fname.img <- switch(fig.type,
#      'CUSTOM'=  paste0(CFG$var, '_', src, '_', CFG$model, 'x', CFG$obs, '_', CFG$ltime),
      'CUSTOM'=  paste0(CFG$var, '_', src, '_', CFG$model, 'x', CFG$obs, '_', CFG$ltime, '_', season),
...
# ==============================================================================
  ...
  my.direction <- NA
  fname.img <- switch(fig.type,
#      'CUSTOM' = paste0(MEC_var, '_', src, '_', MEC_metric, "_", CFG$obs, '_', MEC_ltime),
      'CUSTOM'  = paste0(MEC_var, '_', src, '_', MEC_metric, "_", CFG$obs, '_', MEC_ltime, '_', season),
