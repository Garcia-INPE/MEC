  ...
  for RES in "${RESs[@]}"; do
    for REG in "${REGs[@]}"; do
      for MOD in "${MEC_models[@]}"; do
        ...
        #MEC_QTD_FILES=`ls -l ${MEC_var}_${MOD}_???_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg 2>/dev/null | wc -l`
        #print "DEBUG MEC_QTD_FILES=$MEC_QTD_FILES"
        #echo "ls -l ${MEC_var}_${MOD}_???_${MEC_PRIOR_NAME}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg"
        if [ "${MEC_QTD_FILES}" != "0" ] ; then
          ...
          #MEC_FNAME=${MEC_D_deploy}/IMG/Img_FCT_${MEC_var}_${MOD}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg
          ...
          #montage -tile 1x ${MEC_var}_${MOD}_???_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg -geometry +1+1 ${MEC_FNAME}

          # BIAS -------------------------------------------------------------------
          MEC_FNAME=${MEC_D_deploy}/IMG/Img_BIAS_${MEC_var}_${MOD}x${MEC_obs}_${MEC_PRIOR_NAME}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg
          #MEC_FNAME=${MEC_D_deploy}/IMG/Img_BIAS_${MEC_var}_${MOD}x${MEC_obs}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg
          touch ${MEC_FNAME}; rm -f ${MEC_FNAME}
          ...
          #montage -tile 1x ${MEC_var}_BIAS_${MOD}x${MEC_obs}_???_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg -geometry +1+1 ${MEC_FNAME}

          # SCORR -------------------------------------------------------------------
          MEC_FNAME=${MEC_D_deploy}/IMG/Img_SCORR_${MEC_var}_${MOD}x${MEC_obs}_${MEC_PRIOR_NAME}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg
          #MEC_FNAME=${MEC_D_deploy}/IMG/Img_SCORR_${MEC_var}_${MOD}x${MEC_obs}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg
          touch ${MEC_FNAME}; rm -f ${MEC_FNAME}
          ...
          #montage -tile 1x ${MEC_var}_SCORR_${MOD}x${MEC_obs}_???_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg -geometry +1+1 ${MEC_FNAME}

          # SRMSE -------------------------------------------------------------------
          MEC_FNAME=${MEC_D_deploy}/IMG/Img_SRMSE_${MEC_var}_${MOD}x${MEC_obs}_${MEC_PRIOR_NAME}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg
          #MEC_FNAME=${MEC_D_deploy}/IMG/Img_SRMSE_${MEC_var}_${MOD}x${MEC_obs}_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg
          touch ${MEC_FNAME}; rm -f ${MEC_FNAME}
          ...
          #montage -tile 1x ${MEC_var}_SRMSE_${MOD}x${MEC_obs}_???_${MASK}_${RES}_${REG}_${MEC_init_time}.jpeg -geometry +1+1 ${MEC_FNAME}
        fi
      done
      # ===========================
      # Joining BESTOF
