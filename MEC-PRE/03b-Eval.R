...
# ------------------------------------------------------------------------------
if (MEC_per_type == "CUSTOM") {
   fname.eval.obs <- paste0(DIR$eval, 'OBS_', CFG$var, '_', CFG$obs, '_', MEC_valid_date1, '_', MEC_valid_date2, '.RData')
} else {
...
# ------------------------------------------------------------------------------
if (MEC_per_type == "CUSTOM") {
   fname.eval.cont <- paste0(DIR$eval, 'EVAL_CONT_', CFG$eval.key, '_', MEC_valid_date1, '_', MEC_valid_date2, '_', CFG$hh, '.RData')
} else {
...
if (CFG.SET$eval.cat) {
  if (MEC_per_type == "CUSTOM") {
     fname.eval.cat <- paste0(DIR$eval, 'EVAL_CAT_', CFG$eval.key, '_', MEC_valid_date1, '_', MEC_valid_date2, '_', CFG$hh, '.RData')
  } else {
  ...
  # ------------------------------------------------------------------------------
  if (MEC_per_type == "CUSTOM") {
     fname.hist = paste0(DIR$eval, 'HIST_', CFG$eval.key, '_', MEC_valid_date1, '_', MEC_valid_date2, '_', CFG$hh, '.RData')
  } else {
